    ...
    <div id="page-content">
        ...
        <div class="panel">
            ...
            <div id="demo-custom-toolbar2" class="table-toolbar-left">
                ...
                <a class="btn btn-primary" href="{{route('dashboard.staff.create')}}"><i class="demo-pli-plus"></i> Add Staff</a>
            </div>
                        ...
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('dashboard.staff.edit', $item->id) }}" class="btn btn-icon demo-pli-pencil icon-lg add-tooltip" data-original-title="Edit" data-container="body"></a>
                                    <form id="delete_form3" action="{{route('dashboard.staff.destroy', $item->id)}}" method="POST">
                                        @csrf
                                        @method('Delete')
